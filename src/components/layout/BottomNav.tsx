...
function TabLink(props: {
  ...
  return (
    <NavLink
      to={to}
      className="flex flex-1 min-w-0 flex-col items-center justify-end gap-0.5 py-1.5 transition-all duration-200 motion-safe:active:scale-[0.96]"
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-end w-full max-w-lg mx-auto min-h-[56px] pt-1 px-2 gap-2">
        ...
        <div className="flex flex-col items-center justify-end pb-0.5 w-[4.75rem] shrink-0 mx-auto">
          <button
            ...
            className="relative z-40 -mt-[22px] w-14 h-14 rounded-full flex items-center justify-center motion-safe:transition-transform motion-safe:duration-200 motion-safe:active:scale-95 bg-linear-to-br from-[#ff4f73] to-[#ff7089] shadow-[0_10px_28px_rgba(255,79,115,0.48)] border-[3px] border-white ring-1 ring-[#ff4f73]/20"
          >
